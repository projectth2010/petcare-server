<script>
    ...
    $(document).ready(function() {
        ...
        function fetchFaqs(page = 1, limit = 10) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    res.forEach(function(itm) {
                        const row = `<tr>
                            <td>${itm.FaqID}</td><td>${itm.FaqName}</td><td>${itm.Description}</td><td>${itm.AccessStatus}</td>
                            <td><a href="#" class="btn-warning btn btn-warning btn-sm" data-pet-id="${itm.FaqID}">Edit</a> <a href="#" class="btn-delete btn btn-danger btn-sm" data-pet-id="${itm.FaqID}">Delete</a></td>
                        </tr>`;
