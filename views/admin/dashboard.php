        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dashboard Friday 1.0</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Dashboard Friday 1.0</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../dist/img/default-150x150.png" alt="House 2" class="img-circle img-size-32 mr-2">
                                                    House 2
                                                </td>
                                                <td>$21 USD</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../dist/img/default-150x150.png" alt="Amazing House" class="img-circle img-size-32 mr-2">
                                                    Amazing House
                                                </td>
                                                <td>$10 USD</td>
