              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  ...
                  <table id="customersTable" class="table table-striped table-valign-middle">
                    ...
                    <tr>
                      <th>Customerid</th><th>Username</th><th>Password</th><th>Name</th><th>Email</th><th>Phone</th><th>Approvestatus</th> <td>Action</td>
                    </tr>
...
<script>
      ...
      function showSuccessMessage(message) {
        ...
        $(document).ready(function() {
          ...
          $('#dataTable').DataTable({ "ajax": "/api/customer", "columns": [{'data': 'CustomerID'}
, {'data': 'Username'}
, {'data': 'Password'}
, {'data': 'Name'}
, {'data': 'Email'}
...
const ApproveStatus = $('#ApproveStatus').val()
            ...
            const data = {
                CustomerID,Username,Password,Name,Email,Phone,ApproveStatus,
            };
        ...
        function fetchCustomers(page = 1, limit = 10) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    res.forEach(function(itm) {
                        const row = `<tr>
                            <td>${itm.CustomerID}</td><td>${itm.Username}</td><td>${itm.Password}</td><td>${itm.Name}</td><td>${itm.Email}</td><td>${itm.Phone}</td><td>${itm.ApproveStatus}</td>
                            
                            

                            <td><a href="#" class="btn-warning btn btn-warning btn-sm" data-customer-id="${itm.CustomerID}">Edit</a> <a href="#" class="btn-delete btn btn-danger btn-sm" data-customer-id="${itm.CustomerID}">Delete</a></td>
                        </tr>`;
